...
- `tdsr.lab.*` - English SIRA Lab demonstrators for GIGI, starting with social context, facial expression, rock-scissor-paper, and role-clarification guessing-game agents; these agents use the SIRA Lab/PROMETHEUS home-lab persona, focused Valerian detector profiles, and full GIGI physical behaviour output.
