...
- `tdsr.lab.*` - English SIRA Lab demonstrators for GIGI, covering social context, facial expression, rock-scissor-paper, role-clarification guessing-game, and multimodal behaviour agents; these agents use the SIRA Lab/PROMETHEUS home-lab persona, focused Valerian detector profiles, and full GIGI physical behaviour output.
