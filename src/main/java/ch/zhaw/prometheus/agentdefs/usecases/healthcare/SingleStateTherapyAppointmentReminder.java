...
public class SingleStateTherapyAppointmentReminder implements AgentDefinition {
    ...
    static final String PROMPT_STATE = """
            ...
            Apply the shared resistance protocol from the healthcare care context. Therapy-specific sequence:
    ...
    public static final String KEY = "usecases.healthcare.therapy_appointment_reminder";
    ...
    public static Agent createAgentDefinition() {
        return HealthcareAgentFactory.singleStateCareAgent(
                new HealthcareAgentFactory.TaskPrompts(
                        ...
                        PROMPT_FINAL),
                "Valerian Use Cases Healthcare - Therapy Reminder",
                "English healthcare care-center agent for a gentle therapy or activation appointment reminder.",
                "Valerian Use Cases Healthcare therapy reminder",
                "Valerian Use Cases Healthcare therapy reminder complete",
