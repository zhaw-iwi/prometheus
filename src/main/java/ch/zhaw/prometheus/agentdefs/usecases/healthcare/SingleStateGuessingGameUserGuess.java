...
public class SingleStateGuessingGameUserGuess implements AgentDefinition {
    ...
    static final String PROMPT_TO_FINAL = """
            ...
            Return true if the person guessed Valerian's secret item correctly, or refused after several engagement attempts,
    ...
    static final String PROMPT_OUTCOME_EXTRACTION = """
            ...
            Structure:
            {
              ...
              "outcomes": [
                {
                  "interaction_type": "healthcare_guessing_game_user_guess",
            ...
            - completed is true when the person guessed Valerian's secret item correctly.
    ...
    public static final String KEY = "usecases.healthcare.guessing_game_user_guess";
    ...
    public static Agent createAgentDefinition() {
        return HealthcareAgentFactory.singleStateCareAgent(
                new HealthcareAgentFactory.TaskPrompts(
                        ...
                        PROMPT_FINAL),
                "Valerian Use Cases Healthcare - User Is Guessing",
                "English healthcare care-center guessing game where the older adult guesses Valerian's item.",
                "Valerian Use Cases Healthcare user is guessing",
                "Valerian Use Cases Healthcare user is guessing complete");
    }
