...
public class TourConversationSocialContextSensitivity implements AgentDefinition {
    ...
    public static final String KEY = "tdsr.core.en.tour_conversation_social_context";
    ...
    public static Agent createAgentDefinition() {
        return TdsrCoreAgentFactory.tourConversationSocialContext(
                ...
                "English-speaking TDSR agent for open conversations with subtle social context awareness.");
    }
