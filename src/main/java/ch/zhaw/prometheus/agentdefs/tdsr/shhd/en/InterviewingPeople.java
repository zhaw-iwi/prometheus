package ch.zhaw.prometheus.agentdefs.tdsr.shhd.en;
...
public class InterviewingPeople extends BaseShhdAgentDefinition {
    private static final LanguageProfile LANGUAGE = TdsrShhdPromptLibrary.ENGLISH;
    ...
    public static final String KEY = "tdsr.shhd.en.interviewing_people";
