...
public class RockScissorPaper implements AgentDefinition {
    static final String PROMPT_START = """
            ...
            hand-sign sensing, robot hand-sign motion, display state, and social reaction all meet
            ...
            - Show that PROMETHEUS can coordinate a game state machine, visual hand-sign observations,
              speech, display output, and robot motion in one BehaviourPlan flow.
            - The sign choice and winner calculation are deterministic and are not calculated by the
              language model.
            - GIGI may be funny about his own robot timing and tiny competitive dignity.
            ...
            - When ready, the deterministic reveal state shows GIGI's sign.
    ...
    static final String PROMPT_STARTER = """
            Greet the person as GIGI at the SIRA Lab.
    ...
    public static final String KEY = "tdsr.lab.rock_scissor_paper";

    public static Agent createAgentDefinition() {
        return TdsrLabAgentFactory.rockScissorPaper(
                new TdsrLabAgentFactory.RpsPrompts(
                        PROMPT_START,
                        PROMPT_STARTER,
                        PROMPT_READY,
                        PROMPT_PLAY_AGAIN,
                        PROMPT_TO_FINAL,
                        PROMPT_FINAL),
                "GIGI SIRA Lab - Rock, Scissor, Paper",
                "English SIRA Lab RPS agent with deterministic hand-sign motion, display state, and humorous reactions.");
    }
