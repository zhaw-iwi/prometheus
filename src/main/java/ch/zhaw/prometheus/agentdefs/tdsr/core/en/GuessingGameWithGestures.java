...
public class GuessingGameWithGestures implements AgentDefinition {
    ...
    public static final String KEY = "tdsr.core.en.guessing_game_with_gestures";
    ...
    public static Agent createAgentDefinition() {
        return TdsrCoreAgentFactory.guessingGameWithGestures(
                ...
                "English-speaking TDSR agent for a yes/no guessing game with accompanying gestures.");
    }
