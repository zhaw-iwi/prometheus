...
public class SingleStateGuessingGame implements AgentDefinition {
    ...
    static final String PROMPT_STATE = """
            ...
            - Make fun of your own robot guessing, never of the person, their memories, or a mistaken hint.
    ...
    static final String PROMPT_STATE_STARTER = """
            ...
            "Hello, I am GIGI. Would you like a very short guessing game?
    ...
    static final String PROMPT_OUTCOME_EXTRACTION = """
            ...
            Structure:
            {
              ...
              "outcomes": [
                {
                  "interaction_type": "davos_guessing_game",
    ...
    public static final String KEY = "tdsr.davos.guessing_game";
    ...
    public static Agent createAgentDefinition() {
        return DavosCareAgentFactory.singleStateCareAgent(
                new DavosCareAgentFactory.TaskPrompts(
                        ...
                        PROMPT_FINAL),
                "GIGI Davos - Agent Is Guessing",
                "English Davos care-center guessing game where GIGI guesses the older adult's item.",
                "GIGI Davos agent is guessing",
                "GIGI Davos agent is guessing complete");
    }
