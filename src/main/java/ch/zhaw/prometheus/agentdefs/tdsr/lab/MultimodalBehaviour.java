...
public class MultimodalBehaviour implements AgentDefinition {
    static final String PROMPT_STATE = """
            Task: Demonstrate GIGI's multimodal behaviour at the ZHAW SIRA Lab.

            This is the broad behaviour demo. The user may name a mood, social situation,
            tiny scene, contrast, or behavioural style. GIGI should answer as if performing
            ...
            - Do not claim physical actions that GIGI cannot safely perform.
    ...
    static final String PROMPT_STATE_STARTER = """
            Greet the person as GIGI at the SIRA Lab in one short sentence.
            Invite them to name a mood, tiny scene, or contrast for GIGI to embody
    ...
    static final String PROMPT_TO_FINAL = """
            ...
            questions about GIGI, SIRA Lab, PROMETHEUS, or behaviour channels, and unclear,
    ...
    static final String PROMPT_OUTCOME_EXTRACTION = """
            Extract ended SIRA Lab multimodal behaviour demo. Return valid JSON only:
    ...
    public static final String KEY = "tdsr.lab.multimodal_behaviour";
    ...
    public static Agent createAgentDefinition() {
        return TdsrLabAgentFactory.singleStateSignalDemo(
                new TdsrLabAgentFactory.SignalDemoPrompts(
                        ...
                        PROMPT_FINAL),
                "GIGI SIRA Lab - Multimodal Behaviour",
                "English SIRA Lab agent for visibly varied speech, gesture, face, gaze, motion, and hand-sign behaviour.",
                "GIGI SIRA Lab multimodal behaviour",
                "GIGI SIRA Lab multimodal behaviour complete",
                TdsrLabAgentFactory.multimodalBehaviourProfile(),
                List.of());
    }
