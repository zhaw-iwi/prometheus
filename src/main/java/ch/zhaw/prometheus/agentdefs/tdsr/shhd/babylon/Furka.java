...
public class Furka extends BaseShhdAgentDefinition {
    private static final LanguageProfile LANGUAGE = TdsrShhdPromptLibrary.BABYLON;
    private static final ScenePrompt SCENE = TdsrShhdPromptLibrary.furka(LANGUAGE);
    ...
    public static final String KEY = "tdsr.shhd.babylon.furka";
