...
public class SocialContextSensitivity implements AgentDefinition {
    ...
    static final String PROMPT_OUTCOME_EXTRACTION = """
            Extract the result of the Social Context demo that just ended.
            ...
            - observed_change_types contains only change types that occurred during the flow.
    ...
    public static final String KEY = "tdsr.core.babylon.social_context_sensitivity";
    ...
    public static Agent createAgentDefinition() {
        return TdsrCoreAgentFactory.socialContextSensitivity(
                ...
                "Multilingual TDSR agent for spontaneous reactions to computed social context changes.");
    }
