...
public class SingleStateSmartGoalCoaching implements AgentDefinition {
    ...
    static final String PROMPT_OUTCOME_EXTRACTION = """
            ...
            Structure:
            {
              ...
              "outcomes": [
                {
                  "interaction_type": "davos_smart_goal_coaching",
    ...
    public static final String KEY = "tdsr.davos.smart_goal_coaching";
    ...
    public static Agent createAgentDefinition() {
        return DavosCareAgentFactory.singleStateCareAgent(
                new DavosCareAgentFactory.TaskPrompts(
                        ...
                        PROMPT_FINAL),
                "GIGI Davos - SMART Goal Coaching",
                "English Davos care-center agent for small SMART goals and first steps.",
                "GIGI Davos SMART goal coaching",
                "GIGI Davos SMART goal coaching complete");
    }
