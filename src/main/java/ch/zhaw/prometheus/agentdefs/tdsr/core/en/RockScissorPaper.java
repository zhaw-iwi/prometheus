...
public class RockScissorPaper implements AgentDefinition {
    static final String PROMPT_START = """
            ...
            You are a TDSR demonstrator for PROMETHEUS and play rock-scissor-paper in English.
    ...
    public static final String KEY = "tdsr.core.en.rock_scissor_paper";
    ...
    public static Agent createAgentDefinition() {
        return TdsrCoreAgentFactory.rockScissorPaper(
                ...
                "English-speaking TDSR agent for rock-scissor-paper with deterministic motion.handSign output.");
    }
