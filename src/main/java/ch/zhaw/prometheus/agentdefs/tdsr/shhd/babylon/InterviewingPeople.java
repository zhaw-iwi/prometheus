package ch.zhaw.prometheus.agentdefs.tdsr.shhd.babylon;
...
public class InterviewingPeople extends BaseShhdAgentDefinition {
    private static final LanguageProfile LANGUAGE = TdsrShhdPromptLibrary.BABYLON;
    private static final ScenePrompt SCENE = TdsrShhdPromptLibrary.interviewingPeople(LANGUAGE);
    ...
    public static final String KEY = "tdsr.shhd.babylon.interviewing_people";
