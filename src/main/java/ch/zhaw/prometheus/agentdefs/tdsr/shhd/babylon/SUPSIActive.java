...
public class SUPSIActive extends BaseShhdAgentDefinition {
    private static final LanguageProfile LANGUAGE = TdsrShhdPromptLibrary.BABYLON;
    private static final ScenePrompt SCENE = TdsrShhdPromptLibrary.supsiActive(LANGUAGE);
    ...
    public static final String KEY = "tdsr.shhd.babylon.supsi_active";
