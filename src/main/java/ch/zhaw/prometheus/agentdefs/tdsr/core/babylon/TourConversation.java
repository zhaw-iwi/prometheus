...
public class TourConversation implements AgentDefinition {
    ...
    static final String PROMPT_OUTCOME_EXTRACTION = """
            Extract the result of the TDSR tour conversation that just ended.
            ...
            - discussed_topics and visitor_questions may be empty.
    ...
    public static final String KEY = "tdsr.core.babylon.tour_conversation";
    ...
    public static Agent createAgentDefinition() {
        return TdsrCoreAgentFactory.tourConversation(
                ...
                "Multilingual TDSR agent for open conversations with visitors at any station.");
    }
