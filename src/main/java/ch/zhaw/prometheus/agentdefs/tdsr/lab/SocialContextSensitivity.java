...
public class SocialContextSensitivity implements AgentDefinition {
    static final String PROMPT_STATE = """
            ...
            React to the social context signals as GIGI, not as a dashboard.
            ...
            Answer questions about SIRA Lab, PROMETHEUS, GIGI, sensing, or the demo briefly.
    ...
    static final String PROMPT_OUTCOME_EXTRACTION = """
            Extract ended SIRA Lab social-context demo. Return valid JSON only:
    ...
    public static final String KEY = "tdsr.lab.social_context_sensitivity";
    ...
    public static Agent createAgentDefinition() {
        return TdsrLabAgentFactory.singleStateSignalDemo(
                new TdsrLabAgentFactory.SignalDemoPrompts(
                        ...
                        PROMPT_FINAL),
                "GIGI SIRA Lab - Social Context Sensitivity",
                "English SIRA Lab agent that humorously comments on rich social context signals.",
                "GIGI SIRA Lab social context sensitivity",
                "GIGI SIRA Lab social context sensitivity complete",
                TdsrLabAgentFactory.socialContextProfile(),
                List.of(
