...
class SingleStateMultimodalIn {
    private static final ch.zhaw.prometheus.agentdefs.multimodal.SingleStateMultimodalIn DEFINITION = new ch.zhaw.prometheus.agentdefs.multimodal.SingleStateMultimodalIn();
