...
class SingleStateMultimodalOut {
    private static final ch.zhaw.prometheus.agentdefs.multimodal.SingleStateMultimodalOut DEFINITION = new ch.zhaw.prometheus.agentdefs.multimodal.SingleStateMultimodalOut();
