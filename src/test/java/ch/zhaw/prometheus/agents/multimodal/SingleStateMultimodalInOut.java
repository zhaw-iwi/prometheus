...
class SingleStateMultimodalInOut {
    private static final ch.zhaw.prometheus.agentdefs.multimodal.SingleStateMultimodalInOut DEFINITION = new ch.zhaw.prometheus.agentdefs.multimodal.SingleStateMultimodalInOut();
