...
@SpringBootTest
class SingleStateMultimodalInOut {

        private static final String PROMPT_OUTERSTATE = """
                        Multimodale Ein-/Ausgabevorgaben fuer dieses Ratespiel:
                        ...
                        - Nutze diese Signale als kontextuelle Hinweise fuer Tonfall und Fragefuehrung.
        ...
        void setUp() {
                ...
                Agent agent = new Agent(
                                ...
                                "Single-state guessing game demo with multimodal visual input grounding and built-in nonverbal gesture output.",
                                outerState,
                                storage);
