...
class SingleStateGuessingGame {
    private static final ch.zhaw.prometheus.agentdefs.basic.SingleStateGuessingGame DEFINITION = new ch.zhaw.prometheus.agentdefs.basic.SingleStateGuessingGame();
