...
class SingleStateMicroCoaching {
    private static final ch.zhaw.prometheus.agentdefs.basic.SingleStateMicroCoaching DEFINITION = new ch.zhaw.prometheus.agentdefs.basic.SingleStateMicroCoaching();
