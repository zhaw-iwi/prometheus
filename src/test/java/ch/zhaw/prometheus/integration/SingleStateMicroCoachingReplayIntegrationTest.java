...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, properties = {
        ...
        "prometheus.gateway.script=classpath:scripts/single-state-micro-coaching-replay-script.json"
})
class SingleStateMicroCoachingReplayIntegrationTest {
    private static final Gson GSON = new Gson();
    private static final String SCRIPT_PATH = "classpath:scripts/single-state-micro-coaching-replay-script.json";
    ...
    private Agent buildAgent() {
        ...
        State interactionState = new State(
                ...
                new PromptPolicy("Micro coaching interaction.", "Starter coaching prompt.", PromptPolicy.DEFAULT_SUMMARISE_PROMPT),
                List.of(toFinal));

        return new Agent(
                "Single State Micro Coaching Replay",
                "Script replay agent for single-state micro coaching.",
                interactionState,
                storage);
    }
