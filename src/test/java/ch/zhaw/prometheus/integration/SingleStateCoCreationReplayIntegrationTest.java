...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, properties = {
        ...
        "prometheus.gateway.script=classpath:scripts/single-state-co-creation-replay-script.json"
})
class SingleStateCoCreationReplayIntegrationTest {
    private static final Gson GSON = new Gson();
    private static final String SCRIPT_PATH = "classpath:scripts/single-state-co-creation-replay-script.json";
    ...
    private Agent buildAgent() {
        ...
        State interactionState = new State(
                "Story Co Creation",
                new PromptPolicy("Story co-creation interaction.", "Starter story prompt.", PromptPolicy.DEFAULT_SUMMARISE_PROMPT),
                List.of(toFinal));

        return new Agent(
                "Single State Co-Creation Replay",
                "Script replay agent for single-state story co-creation.",
                interactionState,
                storage);
    }
